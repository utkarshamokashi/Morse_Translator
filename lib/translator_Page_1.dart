...
var a;
class TranslatorPage1 extends StatelessWidget {
  @override
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: Container(child: IconButton(icon: Icon(Icons.send),color: Colors.black, onPressed: (){})),
                    ...
                    Positioned(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () => Navigator.pushNamed(context,'/TranslateEnglishtoMorse'),
                        color: Color(0xffC9F2DB),
                      ),
                    ),
                    Padding(
                    ...
                    /*Padding(
                      ...
                      child: RaisedButton(
                        shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(color: HexColor('#6BDB9C'))
                        ),
                        color: Colors.teal,
                        //onPressed: ,
                      ),
